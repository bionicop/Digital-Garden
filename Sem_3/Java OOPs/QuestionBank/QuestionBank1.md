...
<< [[Sem_3/Java OOPs/QuestionBank/QuestionBank1.md.md|QuestionBank1]] | [[2022-09-22.md]] >>
...
2. [[<#2>]]
3. [[<#3>]]
4. [[#4|Is Java platform-indipendent? (comment onto it|[comment onto it]])
5. [[#5|Java Program Syntax. (With Explanation.|[With Explanation.]])
6. [[#6|Discuss Structure of Java Program.]]
7. [[#7|Differnet types of Java Tokens. (With Examples.|[With Examples.]])
8. [[#8|Differnece between Primitive vs Reference Data Types.]]
9. [[#9|Exaplin Differnet Data Types in Java.]]
10. [[#10|Differnece between Primitive vs Refernce Data Types.]]
11. [[#11|How do you declare constants in Java. (With Examples.|[With Examples.]])
12. [[#12|How we declare and create Arrays.]]
13. [[#13|Write a Program in Java to perform following :-]]
	i) [[#13.1|Linear searching of an element in an array of Size 'a'.]]
	ii) [[#13.2|Finding the smallest and largest element in array.]]
	iii) [[#13.3|Find Average of all elements in the array.]]
14. [[#14|Differnece between-]]
	i) [[#14.1|Break and continue Statment.]]
	ii) [[#14.2|Labelled & Unlabelled break Statment.]]
	iii) [[#14.3|Switch Case & If Else Ladder.]]
	iv) [[#14.4|All Loops. (with Syntax & Examples.|[with Syntax & Examples.]])
15. [[#15|Multi-Dimentional Array]]
16. [[#16|Write a Program of a 2D Array to find the Row MAX & Column MAX.]]
17. [[#17|Bit-wsie Operators]]
18. [[#18|-MOD3-]]
	1. [[#18.1|Method Overlapping.]]
	2. [[#18.2|How do we create methods? How many ways can a arguments be passed to methods in Java?]]
	3. [[#18.3|Differnece between Class & Objects.]]
	4. [[#18.4|Scope of variables (Instance local stataic|[Instance local stataic]].)
	5. [[#18.5|How to create Enum in Java]]
	  ...
	  - ## **Object-oriented** -
		  ...
		  - Object-oriented means *we organize our software* as a ==combination of different types of objects that incorporate both data and behavior==.
			  - Basic concepts of OOPs are:
				  1. [[Sem_3/Java OOPs/Notes/Module_1/Object_Oriented_Programming.md.md#^edbd1a|Object]]
				  1. [[Sem_3/Java OOPs/Notes/Module_1/Object_Oriented_Programming.md.md#^3ccd44|Class]]
				  2. Inheritance
				  3. Polymorphism
				  4. Abstraction
				  5. Encapsulation
